...
## Steps
1. Read `ux-ui-agent-skills/workflows/prototyping.md` (5-level fidelity ladder, journey mapping template, usability-testing script, sample data).
...
5. High-fi/code steps pull tokens (`ux-ui-agent-skills/tokens/*`), components (`ux-ui-agent-skills/components/*`), taste (`ux-ui-agent-skills/taste/*`), and a11y (`ux-ui-agent-skills/accessibility/*`).
