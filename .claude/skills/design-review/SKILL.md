...
## Steps
1. Read `ux-ui-agent-skills/workflows/design-review.md` (rubric, scoring guide, Nielsen heuristics, process).
...
4. Run the accessibility lens with `ux-ui-agent-skills/accessibility/wcag-checklist.md`; use `ux-ui-agent-skills/scripts/contrast.py` for any color-pair doubts.
5. Check against the anti-slop tells in `ux-ui-agent-skills/taste/design-taste.md` (Banned Defaults checklist).
